...
<!-- Generated from .harness/commands/project/handoff.md; DO NOT EDIT. Run node scripts/sync-harness.mjs. -->
...
Follow `mcp-coordination` and `project-work` for per-case commit/Red evidence,
...
`project-interview` or regenerate the brief; never ask a headless worker to

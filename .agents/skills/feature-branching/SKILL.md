...
**The `<slug>` must equal the entity-page slug** — the branch name (`feat/<slug>`), the entity page, the plan scratch (`.Codex/handoff/<slug>-plan.md`), and the test names all key off it. Pick it once and keep it stable.

...
A gotcha is project-specific failure that would burn the next agent. Generic discipline issues (TDD slips, branch hygiene) go in `.agents/rules.md`. Project-specific traps go in `docs/wiki/gotchas.md`.
